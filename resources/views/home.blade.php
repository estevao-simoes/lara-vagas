...
<body class="antialiased">
    <section class="w-full px-3 antialiased bg-gradient-to-br from-prussian-blue via-gray-900 to-gray-950 lg:px-6">
        <div class="mx-auto max-w-7xl">
            ...
            <div class="container px-6 pt-20 pb-24 mx-auto md:text-center md:px-4">
                <h1 class="font-extrabold leading-snug text-white text-5xl md:text-6xl xl:text-7xl">
                    <span class="block">
                ...
                <div
                    ...
                    <span class="relative top-0 right-0 block">
                        <button type="button"
                            class="backdrop-opacity-10 backdrop-invert inline-flex items-center w-40 h-12 px-8 text-base font-bold leading-3 text-white transition duration-150 ease-in-out bg-gray-800 border border-transparent hover:bg-gray-700 focus:outline-none active:bg-gray-700"
